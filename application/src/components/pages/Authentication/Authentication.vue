  ...
  <div class="l-auth-container">
    <div class="l-auth">
      <v-form v-model="validLogin">
        ...
        <v-btn block flat color="light-blue accent-4" @click.native="signUpVisible = true">Create account</v-btn>
        <v-btn block color="light-blue accent-4" @click.native="submitAuthentication()">Login</v-btn>
      </v-form>
    </div>
    ...
    <div class="l-signup" v-if="signUpVisible">
      <v-form v-model="validSignUp">
        ...
        <v-btn block color="light-blue accent-4" @click.native="submitSignUp()">Sign Up</v-btn>
      </v-form>
    </div>
  ...
  export default {
    data () {
      return {
        ...
        timeout: 6000,
        rules: [ (value) => !!value || 'This field is required, please fill' ],
        credentials: {
          username: '',
          password: ''
        },
